  ...
  <exercise:Exercise>
    <parts xsi:type="exercise:ExercisePart" title="StopWatch">
      <tasks xsi:type="exercise:Task">
        ...
        <a xsi:type="jdt:JdtSourceEditAnswer" className="encapsulation.StopWatch"/>
      </tasks>
      <tasks xsi:type="exercise:Task">
        <q xsi:type="exercise:StringQuestion" question="Run the StopWatch class, to test it."/>
        <a xsi:type="jdt:JdtLaunchAnswer" className="encapsulation.StopWatch"/>
      </tasks>
      <tasks xsi:type="exercise:Task">
        <q xsi:type="exercise:StringQuestion" question="Test the StopWatch class, by running the StopWatchTest JUnit test."/>
        <a xsi:type="junit:JunitTestAnswer" testRunName="encapsulation.StopWatchTest"/>
      </tasks>
    </parts>
