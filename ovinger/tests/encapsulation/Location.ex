  ...
  <exercise:Exercise>
    <parts xsi:type="exercise:ExercisePart" title="Location">
      <tasks xsi:type="exercise:Task">
        ...
        <a xsi:type="jdt:JdtSourceEditAnswer" className="encapsulation.Location"/>
      </tasks>
      <tasks xsi:type="exercise:Task">
        <q xsi:type="exercise:StringQuestion" question="Run the Location class, to test it."/>
        <a xsi:type="jdt:JdtLaunchAnswer" className="encapsulation.Location"/>
      </tasks>
      <tasks xsi:type="exercise:Task">
        <q xsi:type="exercise:StringQuestion" question="Test the Location class, by running the LocationTest JUnit test."/>
        <a xsi:type="junit:JunitTestAnswer" testRunName="encapsulation.LocationTest"/>
      </tasks>
    </parts>
