...
public class Person {
	...
	private static boolean checkDigits(String digits, int pos, int num) {
		return ((num < 10 || num / 10 == digits.charAt(pos) - '0') && num % 10 == digits.charAt(pos + 1) - '0'); 
	} 
	...
	public static void main(String[] args) throws ParseException {
		Person p = new Person();
		p.setBirthday(new SimpleDateFormat("yyyy-MM-dd").parse("2002-07-30"));
		p.setGender('F');
		p.setSSN("30070295209");
