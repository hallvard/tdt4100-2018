...
public class ShoppingCart {
	...
	// objekt-datatyper
	private Map<Item, Double> cart = new HashMap<>();
	...
	public void addItemAmount(Item item, double amount){
		...
		item.addShoppingCart(this, amount);
		//}
	...
	public static void main(String[] args) {
		...
		// Lag noen "ting"
		Item flask = new Item("Flaske", 80, 5);
		Item coat = new Item("Allværsjakke", 150, 8);
		Item membership = new Item("Samfundet-medlemskap", 100, 3);
		Item textBook = new Item("Rottmann", 100, 8);
		Item pants = new Item("Regnbukser", 100, 15);
